...
// ... existing constants ...
const DATA_DIR: &str = ".aiolauncher_server_trans";
const ACCOUNTS_INDEX: &str = "accounts.json";
const ACCOUNTS_DIR: &str = "accounts";

// ... existing functions get_data_dir, get_accounts_dir, load_account_index, save_account_index ...
/// Get data directory path
/// Supports custom data directory via AIOLAUNCHER_DATA_DIR environment variable for multi-instance
pub fn get_data_dir() -> Result<PathBuf, String> {
    // Check for custom data directory from environment variable (for multi-instance support)
    if let Ok(custom_dir) = std::env::var("AIOLAUNCHER_DATA_DIR") {
